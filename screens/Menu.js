...
const Menu = ({ navigation, onClose }) => {
  const menuItems = [
    ...
    {
      label: "Forms for Advocate",
      link: "https://www.latestlaws.com/library/legal-documents/legal-forms-for-advocates",
    },
    {
      label: "Bail Application",
      link: "https://www.advocatekhoj.com/library/agreements/criminallaw/2.php",
    },
    { label: "Complaints" },
    { label: "Donate Us" },
